...
final class UsageStore {
    ...
    /// Fired after a multi-account Codex refresh commits `codexAccountSnapshots` (see auto failover).
    @ObservationIgnored var onCodexAccountSnapshotsDidRefresh: (@MainActor () -> Void)?
